  ...
  if (!contact || !contact.name || !contact.email) {
    return (
      <div className="message-warning">
        <p className="message-warning-text">Contact information is incomplete</p>
      ...
      <div className="contact-card-header">
        <div className="contact-profile-section">
          ...
          <div className="contact-profile-avatar">
            <span className="contact-profile-avatar-text">
              {firstLetter}
            </span>
          </div>
          <h2 className="contact-profile-name">{contact.name}</h2>
          <p className="contact-profile-subtitle">Software Developer</p>
        </div>
      </div>
  ...
  if (status !== 'success') {
    return (
      <div className="message-error">
        <p className="message-error-text">Unable to load contact information: {error}</p>
      </div>
    )
  }
