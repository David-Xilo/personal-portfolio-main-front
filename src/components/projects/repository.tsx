...
const RepositoryCard: React.FC<{repository: RepositoryInfo}> = ({
  repository,
}) => {
  return (
    <div className="repository-card" onClick={e => e.stopPropagation()}>
...
const RepositoryCarousel: React.FC<{repositories: RepositoryInfo[]}> = ({
  repositories,
}) => {
  ...
  const canGoRight =
    currentIndex < maxIndex && repositories.length > cardsPerView
