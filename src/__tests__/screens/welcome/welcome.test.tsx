...
describe('WelcomeScreen', () => {
  ...
  test('renders welcome introduction text', () => {
    ...
    expect(
      screen.getByText(/Hello! Welcome to my personal page/),
    ).toBeInTheDocument()
    expect(
      screen.getByText(/I've made this to hold myself accountable/),
    ).toBeInTheDocument()
  })
  ...
  test('renders navigation instruction text', () => {
    ...
    expect(
      screen.getByText(/You can navigate through my interests/),
    ).toBeInTheDocument()
  })
