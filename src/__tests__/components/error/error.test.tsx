...
describe('ErrorMessage', () => {
  ...
  test('applies inline variant when specified', () => {
    const {container} = render(
      <ErrorMessage error={mockErrorProps} variant="inline" />,
    )
  ...
  test('applies custom className', () => {
    const {container} = render(
      <ErrorMessage error={mockErrorProps} className="custom-error" />,
    )
  ...
  test('trims className properly with custom className', () => {
    const {container} = render(
      <ErrorMessage error={mockErrorProps} className="custom" />,
    )
  ...
  test('handles empty className', () => {
    const {container} = render(
      <ErrorMessage error={mockErrorProps} className="" />,
    )
  ...
  test('structure is correct for stacked variant', () => {
    const {container} = render(
      <ErrorMessage error={mockErrorProps} variant="stacked" />,
    )

    expect(container.querySelector('.error-message')).toBeInTheDocument()
    expect(
      container.querySelector('.error-message-stacked'),
    ).toBeInTheDocument()
    expect(container.querySelector('.error-message-pre')).toBeInTheDocument()
    expect(
      container.querySelector('.error-message-pre-stacked'),
    ).toBeInTheDocument()
  })
  ...
  test('structure is correct for inline variant', () => {
    ...
    expect(container.querySelector('.error-message-pre')).toBeInTheDocument()
    expect(
      container.querySelector('.error-message-pre-inline'),
    ).toBeInTheDocument()
  })
})
