...
import {FullPageErrorFallback, ErrorFallback} from '../../../components/error/error-fallback'
...
describe('FullPageErrorFallback', () => {
  ...
  test('renders error message', () => {
    render(<FullPageErrorFallback error={mockError} resetErrorBoundary={mockReset} />)
    
    expect(screen.getByText('Uh oh... There is a problem. Try refreshing the app.')).toBeInTheDocument()
  })
  ...
  test('has correct CSS class', () => {
    const { container } = render(<FullPageErrorFallback error={mockError} resetErrorBoundary={mockReset} />)
  ...
  test('renders with different error messages', () => {
    ...
    render(<FullPageErrorFallback error={differentError} resetErrorBoundary={mockReset} />)
