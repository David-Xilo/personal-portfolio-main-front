...
describe('IntroductionCard', () => {
  ...
  test('applies correct color class', () => {
    const {container} = render(
      <IntroductionCard {...defaultProps} color="pink" />,
    )
  ...
  test('renders children content correctly', () => {
    ...
    render(
      <IntroductionCard {...defaultProps}>{customChildren}</IntroductionCard>,
    )
  ...
  test('has correct CSS classes structure', () => {
    ...
    expect(
      container.querySelector('.intro-card__icon-container'),
    ).toBeInTheDocument()
    ...
    expect(
      container.querySelector('.intro-card__description'),
    ).toBeInTheDocument()
  })
  ...
  test('supports all color options', () => {
    ...
    colors.forEach(color => {
      const {container, unmount} = render(
        <IntroductionCard {...defaultProps} color={color} />,
      )
