...
describe('IntroHeader', () => {
  ...
  test('applies correct gradient classes with three colors', () => {
    ...
    expect(underlineElement).toHaveClass('intro-header__underline--red-green-blue')
  })
  ...
  test('applies correct icon gradient classes', () => {
    ...
    const rightIconElement = container.querySelectorAll('.intro-header__icon')[1]
  ...
  test('has correct CSS structure', () => {
    ...
    expect(container.querySelector('.intro-header__content')).toBeInTheDocument()
    expect(container.querySelector('.intro-header__title')).toBeInTheDocument()
    expect(container.querySelector('.intro-header__underline')).toBeInTheDocument()
  })
