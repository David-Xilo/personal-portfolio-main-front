...
describe('ContentListItem', () => {
  ...
  test('renders children when expanded', () => {
    ...
    render(<ContentListItem {...defaultProps}>{children}</ContentListItem>)
  ...
  test('has correct CSS classes', () => {
    ...
    expect(
      container.querySelector('.content-list-item-arrow'),
    ).toBeInTheDocument()
    expect(
      container.querySelector('.content-list-item-content'),
    ).toBeInTheDocument()
    expect(
      container.querySelector('.content-list-item-title'),
    ).toBeInTheDocument()
    expect(
      container.querySelector('.content-list-item-description'),
    ).toBeInTheDocument()
  })
})
