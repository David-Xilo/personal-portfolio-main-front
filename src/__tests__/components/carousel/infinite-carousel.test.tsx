...
describe('InfiniteCarousel', () => {
  ...
  test('renders single item without navigation when only one item', () => {
    render(<InfiniteCarousel items={['Single Item']} renderItem={renderTestItem} />)
  ...
  test('hides arrows when showArrows is false', () => {
    render(<InfiniteCarousel items={mockItems} renderItem={renderTestItem} showArrows={false} />)
  ...
  test('hides indicators when showIndicators is false', () => {
    render(<InfiniteCarousel items={mockItems} renderItem={renderTestItem} showIndicators={false} />)
  ...
  test('applies custom className', () => {
    const { container } = render(
      <InfiniteCarousel items={mockItems} renderItem={renderTestItem} className="custom-class" />
    )
  ...
  test('applies size prop correctly', () => {
    const { container } = render(
      <InfiniteCarousel items={mockItems} renderItem={renderTestItem} size="large" />
    )
