...
import {
  RepositoryCarousel,
  RepositoryInfo,
} from '../../../components/projects/repository'
...
describe('RepositoryCarousel', () => {
  ...
  test('renders empty state when no repositories', () => {
    ...
    expect(
      screen.getByText('No repositories available for this project.'),
    ).toBeInTheDocument()
  })
  ...
  test('navigates left when left arrow clicked', () => {
    ...
    expect(
      screen.queryByLabelText('Previous repositories'),
  ...
  test('handles keyboard navigation', () => {
    ...
    const carousel = screen
      .getByText('First Repo')
      .closest('.repository-carousel')
  ...
  test('has correct CSS classes and structure', () => {
    ...
    expect(
      container.querySelector('.repository-carousel-container'),
    ).toBeInTheDocument()
    expect(
      container.querySelector('.repository-carousel-track'),
    ).toBeInTheDocument()
    expect(
      container.querySelector('.repository-carousel-items'),
    ).toBeInTheDocument()
    expect(container.querySelector('.repository-card')).toBeInTheDocument()
    expect(
      container.querySelector('.repository-card-content'),
    ).toBeInTheDocument()
    expect(
      container.querySelector('.repository-card-title'),
    ).toBeInTheDocument()
    expect(
      container.querySelector('.repository-card-description'),
    ).toBeInTheDocument()
    expect(
      container.querySelector('.repository-card-actions'),
    ).toBeInTheDocument()
  })

  test('applies transform styles for navigation', () => {
    const {container} = render(
      <RepositoryCarousel repositories={mockRepositories} />,
    )
