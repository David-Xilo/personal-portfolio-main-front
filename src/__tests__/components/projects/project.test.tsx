...
import {ProjectComponent, GenericProjectsScreen} from '../../../components/projects/project'
...
describe('ProjectComponent', () => {
  ...
  test('renders singular form for single repository', () => {
    const singleRepoProject = { ...mockProject, repositories: [mockProject.repositories[0]] }
  ...
  test('stops event propagation on click', () => {
    ...
    const projectComponent = screen.getAllByText('2 repositories')[0].closest('.project-component')
...
describe('GenericProjectsScreen', () => {
  const mockUseProjectsGetApi = useProjectsGetApi as jest.MockedFunction<typeof useProjectsGetApi>
  ...
  test('renders error state when API fails', () => {
    ...
    render(<GenericProjectsScreen projectsPath="/api/projects" projectName="Test Projects" />)
  ...
  test('renders default error message when no specific error', () => {
    ...
    expect(screen.getByText('An unexpected error occurred while loading Test Projects.')).toBeInTheDocument()
  })
  ...
  test('renders empty state when no projects available', () => {
    ...
    expect(screen.getByText('There are currently no test projects to display. Check back later for updates!')).toBeInTheDocument()
  })
